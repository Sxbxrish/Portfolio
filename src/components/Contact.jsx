...
import contactBgVideo from '../assets/media/videos/contact_bg.mp4';
                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-start">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="hidden md:block">
                            ...
                            <a href="mailto:sabaofficial15@gmail.com" className="text-xl tracking-wide hover:text-gray-300 transition-colors">
                                sabaofficial15@gmail.com
                            </a>
                        </div>
                        ...
                        <div className="hidden md:block">
                            ...
                            <a
                                href="tel:+917719509307"
                                aria-label="Call +91 7719509307"
                                title="Call +91 7719509307"
                                className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.88.32 1.73.6 2.54a2 2 0 0 1-.45 2.11L8 8.59a16 16 0 0 0 6 6l1.22-1.26a2 2 0 0 1 2.11-.45c.81.28 1.66.48 2.54.6A2 2 0 0 1 22 16.92z"/>
                                </svg>
                            </a>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col items-center md:items-start">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-3">
                                <a href="https://www.instagram.com/_.sxbxrish._?igsh=NDlhZ3RsdTNpM2Nl" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                ...
                                <a href="https://www.linkedin.com/in/sabarish-ramalingam" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <a href="https://github.com/Sxbxrish" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
