...
import centerImage from '../assets/media/images/hero_center.png';
import resume from '../assets/media/documents/Resume.pdf';

const Hero = ({ onPreloadComplete }) => {
  const [text, setText] = useState('SxBxRISH');
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="font-bold">Digital</span> <span className="font-light italic text-gray-300">Marketer</span>
        </p>
